...
public class Turing {
	...
	public static void main(String[] args) {
		...
		// halt state enter 6 below
		Turing machine = new Turing(6);
		initializeInputTape(machine.tape, input, machine.tapeHead);

		Transition t0 = new Transition('0', Transition.RIGHT, 1);
		machine.addTransition(0, '1', t0);
		machine.addTransition(5, '1', t0);

		Transition t1 = new Transition('1', Transition.RIGHT, 1);
		machine.addTransition(1, '1', t1);
		
		Transition t2 = new Transition('B', Transition.RIGHT, 2);
		machine.addTransition(1, 'B', t2);

		Transition t3 = new Transition('1', Transition.LEFT, 3);
		machine.addTransition(2, 'B', t3);
		machine.addTransition(3, '1', t3);
		
		Transition t4 = new Transition('1', Transition.RIGHT, 2);
		machine.addTransition(2, '1', t4);
		
		Transition t5 = new Transition('B', Transition.LEFT, 4);
		machine.addTransition(3, 'B', t5);
		
		Transition t6 = new Transition('1', Transition.LEFT, 4);
		machine.addTransition(4, '1', t6);
		
		Transition t7 = new Transition('1', Transition.RIGHT, 5);
		machine.addTransition(4, '0', t7);
		
		Transition t8 = new Transition('B', Transition.RIGHT, 6);
		machine.addTransition(5, 'B', t8);
		machine.addTransition(0, 'B', t8);
